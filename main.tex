...
\begin{titlepage}
    \centering
    \textbf{\large{Thompson Sampling for Bandit Convex Optimization\\(Version 1.1)}}
...
\begin{proof}
    ...
    \begin{proof}
        ...
        \begin{enumcases}
            ...
            By the definition of $J_\delta(\cC)$ it follows that there exists a $h \in \cC$ such that
            ...
            \texttt{(d)} follows from \cref{eq:ts-ridge:rel} and because $f(x'_f) \leq f(x'_h)$;
            and \texttt{(e)} uses again that $f$ is a Lipschitz ridge function and Lemma~\ref{lem:lip} and that $|\sip{x_h' - x_h, \theta}| = \delta$.
